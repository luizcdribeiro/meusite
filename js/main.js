//SCROLL SUAVE
// NO HTML, NA PARTE DO MENU, ACRESCENTAR CLASS = 'JS-MENU' PARA MANIPULAR OS LINKS DO MENU

function intoScrollSuave(){
...
$(".rslides").responsiveSlides({
  ...
  timeout: 5000,          // Integer: Time between slide transitions, in 
});
...
$('.formphp').on('submit', function() {
	var emailContato = "luizjunior.dantas@gmail.com"; // Contato@bikcraft.com
